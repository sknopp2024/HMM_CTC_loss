...
# sequential with for-loops, L = 500 000
...
comp_time_0 = np.zeros((len(one_hot_batch_list), num_of_repeat_slow_alg), dtype = float)  
gpu_list_0 = []
ram_list_0 = [] 
...
try:
    ...
    for i in [5]: #range(len(one_hot_batch_list)):  
...
#save data
save_data(save_dir, comp_time_0, gpu_list_0, ram_list_0, 'nested_scaled_long')